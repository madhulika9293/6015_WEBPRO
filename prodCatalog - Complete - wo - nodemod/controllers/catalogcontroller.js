...
module.exports = function(app) {
    ...
    app.post('/:id', urlencodedParser, function(req, res) {
        ...
        // }    
            ...
            jsonproducts.products[index].title = req.body.title;
            jsonproducts.products[index].description = req.body.prodesc;
            jsonproducts.products[index].quantity = req.body.quantity;
